                    ...
                    <div class="flex flex-col justify-between bg-white shadow-sm rounded-lg p-4 border border-gray-100 transition-all duration-300 hover:shadow-[0_0_15px_rgba(220,38,38,0.6)]">
                        ...
                        <div class="flex gap-2">
                            ...
                            <?php else: ?>
                                ...
                                class="flex-1 bg-yellow-500 hover:bg-yellow-700 text-white text-xs font-medium px-3 py-2 rounded shadow-md text-center transition-all duration-300">
                                    <i class="fa-solid fa-file-circle-question"></i> RULES
                                </a>
                            <?php endif; ?>
                        </div>
